function LoadAventador(config, scene, loadCar) {
    ...
    gltfLoader.load(
        ...
        function (gltf) {
            ...
            car.scene.traverse(function (obj) {
                ...
                if(!loadCar){
                    THREE.SceneUtils.traverseHierarchy( car.scene, function ( object ) { object.visible = false; } );
                }
...
function SetupEnvironment(scene, manager, urls, textureLoader) {
    ...
    DTX_Floor.wrapS = DTX_Floor.wrapT = THREE.RepeatWrapping;
    DTX_Floor.repeat.set(64, 64);
    NTX_Floor.wrapS = NTX_Floor.wrapT = THREE.RepeatWrapping;
    NTX_Floor.repeat.set(64, 64);
    RTX_Floor.wrapS = RTX_Floor.wrapT = THREE.RepeatWrapping;
    RTX_Floor.repeat.set(64, 64);
    //Create the  floor material
    var Mt_Floor = new THREE.MeshStandardMaterial({
        roughness: 1,
        metalness: 0,
        map: DTX_Floor,
        normalMap: NTX_Floor,
        roughnessMap: RTX_Floor
    });
    ...
    var mShadowPlane = new THREE.Mesh(new THREE.PlaneGeometry(36, 18, 1, 1), new THREE.MeshBasicMaterial({
        color: 0xffffff,
        map: DTX_Shadow,
        transparent: true
    }));
